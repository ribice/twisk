...
/*
Package iam is a generated twirp stub package.
...
func NewIAMProtobufClient(addr string, client HTTPClient) IAM {
	prefix := urlBase(addr) + IAMPathPrefix
	urls := [2]string{
		prefix + "Auth",
		prefix + "Refresh",
	}
...
func (c *iAMProtobufClient) Auth(ctx context.Context, in *AuthReq) (*AuthResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twisk.iam")
...
func (c *iAMProtobufClient) Refresh(ctx context.Context, in *RefreshReq) (*RefreshResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twisk.iam")
	ctx = ctxsetters.WithServiceName(ctx, "IAM")
...
func (c *iAMJSONClient) Auth(ctx context.Context, in *AuthReq) (*AuthResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twisk.iam")
	ctx = ctxsetters.WithServiceName(ctx, "IAM")
	ctx = ctxsetters.WithMethodName(ctx, "Auth")
	out := new(AuthResp)
...
func (c *iAMJSONClient) Refresh(ctx context.Context, in *RefreshReq) (*RefreshResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twisk.iam")
	ctx = ctxsetters.WithServiceName(ctx, "IAM")
	ctx = ctxsetters.WithMethodName(ctx, "Refresh")
	out := new(RefreshResp)
...
// IAMPathPrefix is used for all URL paths on a twirp IAM server.
// Requests are always: POST IAMPathPrefix/method
...
func (s *iAMServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twisk.iam.IAM/Auth":
		s.serveAuth(ctx, resp, req)
		return
	case "/twirp/twisk.iam.IAM/Refresh":
...
func (s *iAMServer) serveAuth(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *iAMServer) serveAuthJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Auth")
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *AuthResp and nil error while calling Auth. nil responses are not supported"))
		return
	}
...
func (s *iAMServer) serveAuthProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Auth")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *iAMServer) serveRefresh(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *iAMServer) serveRefreshJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Refresh")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		...
		respContent, err = s.Refresh(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *RefreshResp and nil error while calling Refresh. nil responses are not supported"))
		return
	}
...
func (s *iAMServer) serveRefreshProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Refresh")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
